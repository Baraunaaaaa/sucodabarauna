...
-- AddForeignKey
ALTER TABLE "public"."Option" ADD CONSTRAINT "Option_scemarioId_fkey" FOREIGN KEY ("scemarioId") REFERENCES "public"."Scenario"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
